<template>
    <div class="main">
        ...
        <a href="#">
            <picture>
                <source srcset="../assets/banner2_mobile.png" media="(max-width: 500px)" />
                <source srcset="../assets/banner2.png" media="(max-width: 768px)" />
                <source srcset="../assets/banner2.png" media="(max-width: 1024px)" />
